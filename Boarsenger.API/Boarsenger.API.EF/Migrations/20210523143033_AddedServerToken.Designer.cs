...
namespace Boarsenger.API.EF.Migrations
{
    ...
    [Migration("20210523143033_AddedServerToken")]
    partial class AddedServerToken
    {
            ...
            modelBuilder.Entity("Boarsenger.API.Core.Models.ServerToken", b =>
                {
                    b.HasOne("Boarsenger.API.Core.Models.Server", "Server")
                        .WithOne("ServerToken")
                        .HasForeignKey("Boarsenger.API.Core.Models.ServerToken", "ServerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
